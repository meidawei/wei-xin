...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuex__ = __webpack_require__(91);
...
var store = new __WEBPACK_IMPORTED_MODULE_2_vuex__["a" /* default */].Store({
  ...
  mutations: {
    getData: function getData(state) {
      ...
      if (obj.canGet) {
        ...
        setTimeout(function () {
          ...
          (_obj$goodsData = obj.goodsData).push.apply(_obj$goodsData, [{
            key: '001',
            name: '商品1',
            price: '100$'
          }, {
    ...
    setSkey: function setSkey(state, data) {
    ...
    setShow: function setShow(state) {
      if (state.sKey === '') {
        ...
        state.showData = state.goodsData.filter(function (item) {
          var data = state.sKey;
    ...
    shopping: function shopping(state, data) {
      var obj = state;
      var canAnd = obj.shopping.filter(function (item) {
      ...
      if (canAnd === 0) {
        ...
        data[0].number = 1;
        (_obj$shopping = obj.shopping).push.apply(_obj$shopping, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(data));
      } else {
        obj.shopping.map(function (item) {
